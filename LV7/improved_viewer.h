...
public:
    ...
    void iscrtajPoli();
    std::vector<easy3d::vec3> convHull();
    std::vector<easy3d::vec3> areaSearchNaive(double x1, double x2, double y1, double y2);
    void ucitajPoliIzDatoteke(const std::string &ime);
protected:
